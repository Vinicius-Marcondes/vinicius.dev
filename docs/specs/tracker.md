...
| SPEC-005 | Frontend Architecture | Frontend | Review | unassigned | SPEC-002, SPEC-003, SPEC-004, SPEC-017 | SPEC-006, SPEC-007, SPEC-009, SPEC-011, SPEC-018 | no | yes | no | Applies the frontend structure policy to runtime, routes, and migration gates. |
...
| SPEC-015 | GitHub Project Execution | Process | Review | unassigned | README, SPEC-012 | all implementation tasks, SPEC-018 | n/a | yes | yes | Defines issue + project execution workflow. |
...
| SPEC-017 | Frontend Structure | Frontend | Review | unassigned | SPEC-002, SPEC-003, SPEC-004 | SPEC-005, SPEC-009, SPEC-011, SPEC-018 | yes | yes | yes | Defines strict FSD, Data Router placement, and public/admin shell structure. |
